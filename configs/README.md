...
| `experiment.yaml` | 데이터, split manifest, 결과 경로와 2단계 추론 옵션을 정의합니다. |

`experiment.test_npz_path`는 frozen test set입니다. 학습이나 threshold 보정에 사용하면 평가 누수가 발생하므로 변경 시 주의합니다.
